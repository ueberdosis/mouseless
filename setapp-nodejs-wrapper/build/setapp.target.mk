...
OBJS := \
	$(obj).target/$(TARGET)/setapp-lib-mapping.o
...
$(builddir)/setapp.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/setapp.node: LIBS := $(LIBS)
$(builddir)/setapp.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/setapp.node: TOOLSET := $(TOOLSET)
$(builddir)/setapp.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/setapp.node
# Add target alias
.PHONY: setapp
setapp: $(builddir)/setapp.node

# Short alias for building this executable.
.PHONY: setapp.node
setapp.node: $(builddir)/setapp.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/setapp.node
